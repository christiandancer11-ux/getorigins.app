...
export default function TradeLiveFeed({ card }) {
  // TODO: Migrate trade live feed to Supabase
  return (
    <div className="bg-card border border-border/50 rounded-2xl p-6">
      <div className="flex items-center gap-2 mb-4">
        <Radio className="w-5 h-5 text-primary" />
        <h3 className="font-display text-lg font-bold text-foreground">Live Trade Feed</h3>
      </div>
      <div className="text-center py-8">
        <p className="text-muted-foreground">Live trade feed is temporarily unavailable during migration.</p>
      </div>
    </div>
  );
}
