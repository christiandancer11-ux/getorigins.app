          ...
          <div className="text-center py-4">
            ...
            {result.type === 'creator' && (
              <div className="mt-4">
                ...
                <Button onClick={() => { alert('Checkout functionality is temporarily unavailable during migration. All users currently have free access to core features.'); onSuccess && onSuccess(result); onClose(); }} className="w-full bg-primary text-primary-foreground">
